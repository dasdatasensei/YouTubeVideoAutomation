...
- [Windows Installer (.exe)](downloads/windows-installer.exe)
- [macOS Installer (.dmg)](downloads/macos-installer.dmg)
- [Linux Package (.deb)](downloads/linux-package.deb)
...
Need help? Join our [Discord Community](https://discord.gg/youtube-automation) or open an [Issue](https://github.com/yourusername/youtube-automation/issues).
